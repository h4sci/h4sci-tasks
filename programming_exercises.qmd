...
This set of exercises is meant to test your knowledge of the concepts covered in block 2 of the course.
...
Recall the Task 2.1 on sorting students to cards: 
...
::: {.callout-caution}
## Your turn!
Without looking at the answers, try to guess what the result would be in python and R, when copying the result from above and changing following things. Then check your answer!
:::
